...
public class ImmutableTableMetaType extends AbstractMetaType implements TableMetaType {
     ...
     *            null or empty
     * @param rowType the type of the row elements in the tabular data, cannot be
     *            null
     ...
     * @throws IllegalArgumentException when a parameter does not match what is described above or
     *            when an element of indexNames is not defined in rowType.
     */
