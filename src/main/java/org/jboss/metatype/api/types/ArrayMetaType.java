...
public class ArrayMetaType extends AbstractMetaType {
     ...
     *
     * @param typeName
     *            - the primitive wrapper type name
    ...
    private static String genType(int dimension, MetaType elementType,
        ...
        if (elementType instanceof ArrayMetaType)
            throw new IllegalArgumentException(
                    "array type cannot be an element of an array type");
        StringBuilder buffer = new StringBuilder();
        for (int i = 0; i < dimension; i++)
            buffer.append('[');
        if (isPrimitive) {
     ...
     * @throws IllegalArgumentException for a null argument or non-negative dimension or when meta
     *         type is an ArrayMetaType
     */
    public ArrayMetaType(int dimension, MetaType elementType) {
        super(genName(dimension, elementType, false), genType(dimension, elementType, false), genDesc(dimension, elementType, false));
    ...
    public ArrayMetaType(int dimension, MetaType elementType,
        ...
        super(genName(dimension, elementType, primitiveArray), genType(
                dimension, elementType, primitiveArray), genDesc(dimension,
    ...
    public boolean isValue(Object obj) {
        ...
        if (elementType instanceof TableMetaType
                || elementType instanceof CompositeMetaType) {
