...
public class ImmutableCompositeMetaTypeUnitTestCase extends AbstractMetaTypeTest
{
   ...
   /**
    * Initialize a test composite metatype
    *
   ...
   /**
    * Initialize a test composite metatype with different item types
    *
    * @return the meta type
    */
   ...
   /**
    * Initialize a test composite metatype with a different type name
    *
    * @return the meta type
    */
   ...
   /**
    * s a test composite metatype with different item names
    *
    * @return the meta type
    */
