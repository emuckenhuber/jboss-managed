...
public class ImmutableTableMetaTypeUnitTestCase extends AbstractMetaTypeTest
{
   ...
   /**
    * Initialize a test table type with a different type name
    *
    * @return the type
    * @throws Exception for any problem
    */
   ...
   /**
    * Initialize a test table type with different row types
    *
    * @return the type
    * @throws Exception for any problem
    */
   ...
   /**
    * Initialize a test table type with different index names
    *
    * @return the type
    * @throws Exception for any problem
    */
